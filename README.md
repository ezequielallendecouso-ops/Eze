...
| **Fotos de máquinas** | Subir a `assets/img/` con estos nombres exactos: `maquina-prensa-200t.jpg`, `maquina-prensa-90t.jpg`, `maquina-prensa-60t.jpg`, `maquina-prensa-hidraulica-80t.jpg`, `maquina-torno-automatico.jpg`. Proporción 4:3 (ej. 1600×1200). **No hay que tocar código**: el bloque de fotos debajo de la tabla de máquinas aparece solo cuando existe al menos una. |
...
| **Datos técnicos** | Tabla de máquinas (fuente: planilla "Ficha_Maquinas") y bloque "Materiales / Volúmenes / Sectores". Falta un dato real de espesor máximo trabajado en acero inoxidable. |
